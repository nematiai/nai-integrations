...
from apps.core.base.exceptions import ConfigurationError, TokenRefreshError
...
class OneDriveService(BaseCloudService):
    ...
    def _load_auth(self) -> None:
        try:
            self.auth = OneDriveAuth.objects.get(
    ...
    def get_authorization_url(
        ...
        cache_key = (
            f"nemi_od_state_{self.app_client.id}_{self.external_user_id}_{state}"
        )
